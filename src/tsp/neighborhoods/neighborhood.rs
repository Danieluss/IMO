...
impl Neighborhood {
    ...
    pub fn pack(&self, from: usize, to: usize, instance: &TSPInstance) -> usize {
        let n = instance.dimension;
        return 1;
    }

    pub fn score(&mut self, state: usize, instance: &TSPInstance, solution: &TSPSolution) -> Option<(f32, usize)> {
